...
var AutoComplete = _react2.default.createClass({
  ...
  render: function render() {
    ...
    var _props = this.props,
        ...
        other = _objectWithoutProperties(_props, ['anchorOrigin', 'animated', 'style', 'errorStyle', 'floatingLabelText', 'hintText', 'fullWidth', 'menuStyle', 'menuProps', 'listStyle', 'targetOrigin']);
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_textField2.default, _extends({}, other, {
          ...
          , onBlur: function onBlur() {
            if (_this2.focusOnInput && _this2.state.open) {
              (function () {
